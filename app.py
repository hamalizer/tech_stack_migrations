...
st.write('We can see Golang is a very popular choice for tech companies who have decided to migrate their stack to a new language.')
st.write('By-totals, the total number of migrations to golang is near double when accounting for the fact that TiDB is written in GO')
